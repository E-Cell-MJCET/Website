...
function render() {
  if (ctx.running) {
    ...
    gradient.addColorStop(0, "#c2410c"); // Start with reddish-orange
    gradient.addColorStop(1, "#3b82f6"); // End with bright blue

    ctx.globalCompositeOperation = "source-over";
    ctx.clearRect(0, 0, ctx.canvas.width, ctx.canvas.height);
    ctx.globalCompositeOperation = "lighter";
    ctx.strokeStyle = gradient; // Use the gradient as stroke
    ctx.lineWidth = 1;

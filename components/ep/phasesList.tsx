...
function PhasesList() {
  const icons1 = "/assets/ep/epicons/1.png";
  const icons2 = "/assets/ep/epicons/2.png";
  const icons3 = "/assets/ep/epicons/3.png";
  const icons4 = "/assets/ep/epicons/4.png";

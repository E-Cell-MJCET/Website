...
const Brouchere = () => {
  ...
  return (
    <section className="relative z-20 overflow-hidden bg-[#031c35] pb-4 pt-[20px] dark:bg-dark lg:pb-[50px] lg:pt-[70px] px-[20px] lg:mx-0">
          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
              ...
              <a
                ...
                href="https://drive.google.com/file/d/1VQCSOEKpjxFuwCZ5FqzuDeVpAcE0UP7C/view?usp=sharing"
                target="_blank"
              >
                Tap to view
              </a>

  ...
  return (
    <div className="flex text-center justify-center items-start lg:items-center leading-tight flex-grow ">
      ...
      <div className="w-[70%] -mt:20   ">
        ...
        <div className="text-[max(3rem,min(5vw,5rem))] hidden lg:inline font-extrabold  uppercase bg-clip-text text-transparent bg-gradient-to-r from-[#ff403c]  to-[#0b5db0] opacity-100 ">
          Entrepreneurship Cell
        </div>
        {/* </div> */}
        ...
        <div className="relative">
          <div className="text-[max(3.2rem,min(5.6vw,5.6rem))] inline desktop:hidden lg:hidden absolute  -inset-1 blur-sm opacity-60 font-medium blackOps bg-clip-text text-transparent bg-gradient-to-r from-ecell-red-100  to-ecell-blue-100 ">
            E-Cell
          </div>
          <div className="text-[max(3.2rem,min(5.6vw,5.6rem))] inline desktop:hidden lg:hidden font-medium blackOps bg-clip-text text-transparent bg-gradient-to-r from-ecell-red-100  to-ecell-blue-100 opacity-100 ">
            E-Cell
          </div>
        </div>

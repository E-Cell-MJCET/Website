      ...
      <div className="w-[90%]">
        ...
        <div className="flex items-center lg:justify-between flex-col lg:flex-row">
          ...
          <div className="text-sm text-white mt-1 lg:mt-0">
            Developed by{" "}
            <span className=" hover:text-white  hover:underline hover:underline-offset-4 cursor-pointer bg-clip-text text-transparent bg-gradient-to-r from-[#c23c83]  to-[#6b28d5]">
              <Link

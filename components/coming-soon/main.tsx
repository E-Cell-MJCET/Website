...
const Main = () => {
  return (
    <div className="flex flex-col h-screen w-full items-center justify-center text-center">
      ...
      <p className="text-3xl mt-5 md:text-5xl leading-tight font-bold bg-gradient-to-r from-orange-700 to-blue-500 text-transparent bg-clip-text bg-300% animate-gradient">
